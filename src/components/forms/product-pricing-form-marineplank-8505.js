...
class ProductPricingFormMarineplank extends Component {
  constructor(props) {
    super(props)
  ...
  handleSubmit = async event => {
    ...
    const formLink =
      "https://site.mortlock.com.au/wp-json/contact-form-7/v1/contact-forms/8505/feedback"
      ...
      axios
        ...
        .then(res => {
          if (res.data.status === "mail_sent") {
            ...
            setTimeout(() => {
			window.location = "https://www.mortlock.com.au/thank-you-marineplank-pricing/";
          }, 1000);
...
export default ProductPricingFormMarineplank

...
class SampleRequest extends Component {
  ...
  handleSubmit = async event => {
    ...
    const formLink =
      "https://site.mortlock.com.au/wp-json/contact-form-7/v1/contact-forms/30668/feedback"
    let isFormValid = false
    let elements = document.querySelectorAll(".timberguide__form .noEmpty")
        ...
        .then(res => {
          if (res.data.status === "mail_sent") {
            ...
            setTimeout(() => {
              ...
              scrollTo("#download-timber-guide")
            }, 800);
          setTimeout(() => {
			window.location = "https://www.mortlock.com.au/timber-guide-thank-you-page/";
          }, 50);
    ...
    if (popupActive) {
      return (
        <div className="formsub__popup">
          <h3>Thanks for requesting Timber Guide from Mortlock Timber.</h3>
		  <p>You can download our Timber Guide below.</p>
          <a
            class="link"
            target="_blank"
            rel="noreferrer"
      ...
      return (
        <form
          className={submitActive ? "timberguide__form loading" : "timberguide__form"}
          id="timberguide__form"
          type="POST"

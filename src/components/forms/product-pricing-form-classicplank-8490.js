...
class ProductPricingFormClassicplank extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    if (popupActive) {
      ...
      return (
        <>
          <form
            className={submitActive ? "pricing__form loading classicplank-pricing-form" : "pricing__form"}
            id="pricing__form"
            type="POST"
...
export default ProductPricingFormClassicplank

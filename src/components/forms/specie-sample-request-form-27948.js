...
class SpecieSampleRequest extends Component {
  constructor(props) {
    super(props)
  ...
  handleSubmit = async event => {
    ...
    const formLink =
      "https://site.mortlock.com.au/wp-json/contact-form-7/v1/contact-forms/27948/feedback"
    ...
    if (isFormValid) {
      ...
      axios
        ...
        .then(res => {
          ...
          setTimeout(() => {
			window.location = "https://www.mortlock.com.au/specie-sample-request-thank-you-page/";
          }, 50);
...
export default SpecieSampleRequest

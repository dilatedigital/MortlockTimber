...
class ProductPricingFormMetroplank extends Component {
  constructor(props) {
    super(props)
  ...
  handleSubmit = async event => {
    ...
    const formLink =
      "https://site.mortlock.com.au/wp-json/contact-form-7/v1/contact-forms/8506/feedback"
...
export default ProductPricingFormMetroplank

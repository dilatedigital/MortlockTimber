            ...
            <div className="slide" key={article.node.wordpress_id}>
              <div className="article">
                ...
                <div className="article_text">
                  <h3><Link to={article.node.path} dangerouslySetInnerHTML={{ __html: article.node.title }} /></h3>
                  {(() => {
                    const regex = /(<([^>]+)>)/gi
                    var removeHTMLtags =
                  ...
                  <Link to={article.node.path} className="read-more">
                    Read more
                  </Link>
                </div>
              </div>
...
export default PricingNewsSlider
